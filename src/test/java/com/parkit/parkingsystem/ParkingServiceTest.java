...
public class ParkingServiceTest {
    ...
    @Test
    @DisplayName("process Exiting Vehicle Test")
	public void processExitingVehicleTest() throws Exception {
		// GIVEN
		ArgumentCaptor<ParkingSpot> parkingSpotArgCapt = ArgumentCaptor.forClass(ParkingSpot.class);
		when(ticketDAO.applyReduction5p(any(Ticket.class))).thenReturn(true);
		...
		verify(ticketDAO, times(1)).applyReduction5p(any(Ticket.class));
    ...
    @Test
    @DisplayName("process Incoming Vehicle Test")
	public void processIncomingVehicleTest() {
		...
		when(ticketDAO.verifyVehicleRegnumber(regNumberString)).thenReturn(true);
		...
		verify(ticketDAO, times(1)).verifyVehicleRegnumber(regNumberString);
    ...
    @Test
    @DisplayName("incoming Vehicule Could Take The Same Parking Spot Than The Same Exiting Vehicule")
	...
	@Test
	@DisplayName("Should Return Exception For Outime Before Intime AtExit")
